...
INSERT INTO `tbl_employees` (`username`, `password`, `person_id`, `deleted`, `hash_version`) VALUES
  ('admin', '$2y$10$vJBSMlD02EC7ENSrKfVQXuvq9tNRHMtcOA8MSK2NYS748HHWm.gcG', 1, 0, 2);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_giftcards`
--

CREATE TABLE `tbl_giftcards` (
...
--
-- Dumping data for table `tbl_giftcards`
--
...
--
-- Table structure for table `tbl_items_taxes`
--

CREATE TABLE `tbl_items_taxes` (
...
--
-- Dumping data for table `tbl_items_taxes`
--
...
--
-- Table structure for table `tbl_item_kits`
--

CREATE TABLE `tbl_item_kits` (
...
--
-- Dumping data for table `tbl_item_kits`
--
...
--
-- Table structure for table `tbl_item_kit_items`
--

CREATE TABLE `tbl_item_kit_items` (
  `item_kit_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  `quantity` decimal(15,3) NOT NULL,
  `kit_sequence` INT(3) NOT NULL DEFAULT 0,
  PRIMARY KEY (`item_kit_id`,`item_id`,`quantity`),
  KEY `tbl_item_kit_items_ibfk_2` (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbl_item_kit_items`
--

-- --------------------------------------------------------

--
-- Table structure for table `tbl_item_quantities`
--

CREATE TABLE IF NOT EXISTS `tbl_item_quantities` (
  `item_id` int(11) NOT NULL,
...
INSERT INTO `tbl_modules` (`name_lang_key`, `desc_lang_key`, `sort`, `module_id`) VALUES
...
INSERT INTO `tbl_people` (`first_name`, `last_name`, `phone_number`, `email`, `address_1`, `address_2`, `city`, `state`, `zip`, `country`, `comments`, `person_id`) VALUES
...
INSERT INTO `tbl_permissions` (`permission_id`, `module_id`) VALUES
...
INSERT INTO `tbl_grants` (`permission_id`, `person_id`, `menu_group`) VALUES
...
--
-- Dumping data for table `tbl_receivings`
--
...
--
-- Table structure for table `tbl_receivings_items`
--

CREATE TABLE `tbl_receivings_items` (
...
--
-- Dumping data for table `tbl_receivings_items`
--
...
--
-- Table structure for table `tbl_sales_items_taxes`
--

CREATE TABLE `tbl_sales_items_taxes` (
...
--
-- Dumping data for table `tbl_sales_items_taxes`
--
...
--
-- Table structure for table `tbl_sales_taxes`
--

CREATE TABLE `tbl_sales_taxes` (
  `sale_id` int(10) NOT NULL,
...
--
-- Dumping data for table `tbl_sales_taxes`
--
...
--
-- Table structure for table `tbl_stock_locations`
--

CREATE TABLE `tbl_stock_locations` (
...
--
-- Dumping data for table `tbl_stock_locations`
--

INSERT INTO `tbl_stock_locations` (`location_name` ) VALUES ('stock');
...
--
-- Table structure for table `tbl_tax_categories`
--
...
--
-- Table structure for table `tbl_tax_codes`
--

CREATE TABLE IF NOT EXISTS `tbl_tax_codes` (
...
--
-- Dumping data for table `tbl_tax_codes`
--
...
--
-- Table structure for table `tbl_tax_code_rates`
--

CREATE TABLE IF NOT EXISTS `tbl_tax_code_rates` (
...
--
-- Dumping data for table `tbl_tax_code_rates`
--
...
--
-- Table structure for table `tbl_dinner_tables`
--

CREATE TABLE `tbl_dinner_tables` (
...
--
-- Dumping data for table `tbl_dinner_tables`
--

INSERT INTO `tbl_dinner_tables` (`name`) VALUES ('Delivery'), ('Take Away');


-- --------------------------------------------------------

--
-- Table structure for table `tbl_customer_packages`
--

CREATE TABLE IF NOT EXISTS `tbl_customers_packages` (
...
INSERT INTO `tbl_customers_packages` (`package_name`, `points_percent`) VALUES
  ('Default', 0),
  ('Bronze', 10),
  ('Silver', 20),
  ('Gold', 30),
...
CREATE TABLE IF NOT EXISTS `tbl_customers_points` (
...
--
-- Table structure for table `tbl_sales_reward_points`
--

CREATE TABLE IF NOT EXISTS `tbl_sales_reward_points` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sale_id` int(11) NOT NULL,
